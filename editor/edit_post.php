    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <div class="form-outline mb-4">
                    <textarea class="form-control" name=" postcontent" id="postcontent" rows="15"><?= $row['content'] ?>
                    </textarea>
...
if (isset($_POST['update_post'])) {
    ...
    if ($_FILES['featureimage']['name'] == '') {
        $sql = "update posts set title='$posttitle', content='$postcontent', category='$postcategory',published='$postpubstatus',image='$post_oldimg' where id=$id";
        if ($conn->query($sql)) {
        ...
        $path = "../assets/img/";
        $sql = "update posts set title='$posttitle', content='$postcontent', category='$postcategory',published='$postpubstatus',image='$filenewname' where id=$id";
        if ($conn->query($sql)) {
